import {
  ForceDirected as ForceDirected2D,
  Circular as Circular2D,
  TreeTopDown as TreeTopDown2D,
  RadialOut as RadialOut2D,
  HierarchicalTopDown as HierarchicalTopDown2D,
  NoOverlap as NoOverlap2D,
  ForceAtlas2 as ForceAtlas22D,
  HierarchicalLeftRight as HierarchicalLeftRight2D,
} from '../../stories/TwoLayouts.story';
import {
  ForceDirected as ForceDirected3D,
  TreeTopDown as TreeTopDown3D,
  RadialOut as RadialOut3D,
} from '../../stories/ThreeLayouts.story';
